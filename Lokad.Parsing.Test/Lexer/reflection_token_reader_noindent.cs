...
{
    [TestFixture]
    public sealed class reflection_token_reader_noindent
    {
        [Tokens(Comments = "//[^\\n]*")]
        private enum Tok
        {
        ...
        public void fields()
        {
            ...
            Assert.AreEqual(Tok.EoS, _reader.Indent);
            Assert.AreEqual(Tok.EoS, _reader.Dedent);
            Assert.AreEqual(Tok.EoS, _reader.EndOfLine);
